...
<div class="card">
    ...
    <div class="card-body">
        <p><strong>الاسم:</strong> <?php echo e(auth('doctor')->user()->name); ?></p>
        <p><strong>البريد الإلكتروني:</strong> <?php echo e(auth('doctor')->user()->email); ?></p>
        <p><strong>الحالة:</strong>
            <?php if(auth('doctor')->user()->status == \App\Enums\StatusEnum::Active->value): ?>

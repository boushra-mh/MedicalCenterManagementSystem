<div class="d-flex flex-column flex-shrink-0 p-3 bg-light shadow" style="width: 250px; min-height: 100vh;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            ...
            <div class="collapse {{ request()->is('admin/doctors*') ? 'show' : '' }}" id="doctorsMenu">
                <ul class="btn-toggle-nav list-unstyled fw-normal small ps-3">
                    <li><a href="{{ route('admin.doctors.index') }}" class="nav-link text-dark">📋 قائمة الأطباء</a></li>
                    <li><a href="{{ route('admin.doctors.create') }}" class="nav-link text-dark">➕ إضافة طبيب</a></li>
                </ul>
            </div>
        </li>
        ...
        <!-- 👥 المرضى -->
        <li>
            <a href="{{ route('admin.patients.index') }}" class="nav-link {{ request()->is('admin/patients*') ? 'active' : 'text-dark' }}">
                👥 المرضى
            </a>
        </li>
        ...
        <li>
            ...
            <div class="collapse {{ request()->is('admin/specialties*') ? 'show' : '' }}" id="specialtiesMenu">
                <ul class="btn-toggle-nav list-unstyled fw-normal small ps-3">
                    <li><a href="{{ route('admin.specialties.index') }}" class="nav-link text-dark">📋 قائمة التخصصات</a></li>
                    <li><a href="{{ route('admin.specialties.create') }}" class="nav-link text-dark">➕ إضافة تخصص</a></li>
                </ul>
            </div>
        </li>
        ...
        <li>
            ...
            <div class="collapse {{ request()->is('admin/appointments*') ? 'show' : '' }}" id="appointmentsMenu">
                <ul class="btn-toggle-nav list-unstyled fw-normal small ps-3">
                    <li><a href="{{ route('admin.appointments.index') }}" class="nav-link text-dark">📋 قائمة المواعيد</a></li>
                    <li><a href="{{ route('admin.appointments.trashed') }}" class="nav-link text-dark">🗑️ المحذوفة</a></li>
                </ul>
            </div>
        </li>

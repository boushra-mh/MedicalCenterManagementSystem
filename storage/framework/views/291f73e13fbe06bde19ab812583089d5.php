...
<?php $__env->startSection('title', __('messages.patient_register')); ?>
        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-header bg-info text-white text-center">
                    <h4><?php echo e(__('messages.patient_register')); ?></h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('user.register')); ?>">
                        ...
                        <div class="mb-3">
                            <label class="form-label">  <?php echo e(__('messages.password_confirmation')); ?></label>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-info"><?php echo e(__('messages.patient_register')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
